...
SCAFFOLD_PLAN = (
    ...
    ("templates/agents/planner.md",     ".claude/agents/planner.md",     "user-config"),
    ("templates/agents/implementer.md", ".claude/agents/implementer.md", "user-config"),
    ...
    ("templates/hooks/render_status_report.py",        ".claude/hooks/render_status_report.py",        "plugin-owned"),
    ("templates/hooks/render_sweep_report.py",         ".claude/hooks/render_sweep_report.py",         "plugin-owned"),
